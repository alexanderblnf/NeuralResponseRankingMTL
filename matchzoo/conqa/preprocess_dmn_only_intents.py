...
if __name__ == '__main__':
    ...
    if data_name == 'mantis_10':
        train_file = 'intent_data_train.tsv'
    ...
    for data_part in list(['train', 'valid', 'test']):
        ...
        prepare.save_relation(cur_data_dir + 'relation_' + data_part + '_only_intents.txt', rels)
        print 'filter queries with duplicated doc ids...'
        prepare.check_filter_query_with_dup_doc(cur_data_dir + 'relation_' + data_part + '_only_intents.txt')
