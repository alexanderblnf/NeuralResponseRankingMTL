...
class DMN_CNN_MTL(BasicModel):
    def __init__(self, config):
        super(DMN_CNN_MTL, self).__init__(config)
        self.__name = 'DMN_CNN_MTL'
        ...
        if not self.check():
            raise TypeError('[DMN_CNN_MTL] parameter check wrong')
        print '[DMN_CNN_MTL] init done'
    ...
    def build(self):
        ...
        word_embed_rep = Flatten()(concatenate(query_embeddings + [d_embed]))
