...
class DMN_CNN_MTL_Web(BasicModel):
    def __init__(self, config):
        super(DMN_CNN_MTL_Web, self).__init__(config)
        self.__name = 'DMN_CNN_MTL_Web'
        ...
        if not self.check():
            raise TypeError('[DMN_CNN_MTL_Web] parameter check wrong')
        print '[DMN_CNN_MTL_Web] init done'
